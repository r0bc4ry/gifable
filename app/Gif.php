...
class Gif extends Model {
    ...
    protected $appends = ['png_url', 'gif_url', 'mp4_url'];
	 ...
	 * @var array
	 */
	protected $fillable = ['shortcode', 'width', 'height', 'png_http_url', 'png_https_url', 'gif_http_url', 'gif_https_url', 'gif_size', 'mp4_http_url', 'mp4_https_url', 'mp4_size'];
	 ...
	 * @var array
	 */
	protected $hidden = ['id', 'png_http_url', 'png_https_url', 'gif_http_url', 'gif_https_url', 'mp4_http_url', 'mp4_https_url'];
